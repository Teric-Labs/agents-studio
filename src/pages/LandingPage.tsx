			...
			<div style={{
				...
				<div className="lp-mobile-header" style={{
					...
					<div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
						<img src={phosaiLogo} alt="PhosAI" style={{ height: '36px', objectFit: 'contain' }} />
						<span style={{ color: '#ffffff', fontSize: '15px', fontWeight: 700, letterSpacing: '0.08em' }}>PhosAI</span>
					</div>
					<div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
						<span style={{ fontSize: '10px', color: '#f0ad44', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
							Enterprise Voice AI
						</span>
					</div>
				</div>
				...
				══════════════════════════════════ */}
				<div className="lp-desktop-panel" style={{
					flex: '0 0 50%',
					background: 'linear-gradient(145deg, #0d0d0d 0%, #161616 50%, #111111 100%)',
					display: 'flex',
				...
				══════════════════════════════════ */}
				<div className="lp-auth-panel" style={{
					flex: 1,
					...
					<div className="lp-auth-inner" style={{ width: '100%', maxWidth: '360px' }}>
